...
const App = () => {
    ...
    useEffect(() => {
        async function getToken() {
            let t = await AsyncStorage.getItem("accessToken");
            setAccessToken(JSON.parse(t));
        }
        getToken();
    }, []);
    if (!loaded) {
    ...
    if (accessToken && accessToken.role === "customer") {
        return (
            <NavigationContainer>
                <Stack.Navigator
                    screenOptions={{
    ...
    } else if(accessToken && accessToken.role === "waiter")  {
        return (
            <NavigationContainer>
                <Stack.Navigator
                    screenOptions={{
